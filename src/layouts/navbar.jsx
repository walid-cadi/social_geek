...
import { FiZap, FiSearch, FiVideo, FiUser, FiShoppingBag, FiBell, FiSettings, FiMessageSquare, FiGlobe } from "react-icons/fi";
  ...
  return (
    <div className="bg-white shadow-md border-0 flex items-center px-5 py-6 ">
      ...
      <div className="flex items-center space-x-2 gap-4 pe-72">
        ...
        <Link to="/marketplace" className="text-center bg-gray-200 p-3 rounded-full">
