                ...
                <div className='bg-white flex justify-between shadow-xl w-[63vw] h-24 items-center p-10 rounded-lg'>
                    ...
                    <div className='flex gap-4'>
                        <div className="flex items-center relative">
                            ...
                            <input type="text" className='w-[15vw] border-0 border-blue-800 bg-blue-50 text-gray-700 p-3 rounded-lg custom-placeholder' placeholder='Search here' value={search} onChange={(e) => setSearch(e.target.value)} />
                        </div>
