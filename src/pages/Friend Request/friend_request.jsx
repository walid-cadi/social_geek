...
const Friend_request = () => {
    ...
    const addFriends = (id) => {
        ...
        if (friend[id]) {
            setUserData(user => ({
                ...user, follows: user.follows.filter(follower => follower !== id)
            }));
        } else {
            setUserData(user => ({
                ...user, follows: [...user.follows, id]
            }));
        }
    ...
    const addFriend = (chlay) => {
        ...
        return (
            <div className='bg-[#f3f4f6] ms-5 mt-3  w-[75vw] pb-10'>
                ...
                <div className='flex flex-wrap w-[75vw] justify-center gap-9 pt-14 ps-20 friend'>
                    {filter.map(user => (
                        <div className='bg-white flex justify-center items-center shadow-lg gap-8 w-[20%]  h-[32vh] rounded-lg div-request '>
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <button onClick={() => addFriend(user.name.first)} className={`px-4 py-2 rounded-full text-[12px] font-bold ${friend[user.name.first] ? 'bg-white text-blue-600 border-2 border-blue-600' : 'bg-blue-600 text-white'}`}>
            ...
            <div className="flex flex-wrap w-[75vw] justify-center gap-9 pt-14 ps-20 friend">
                {dataProfile
                    ...
                    .map((e) => {
                        return (
                            <div
                                className="bg-white flex justify-center items-center shadow-lg gap-8 w-[20%] h-[32vh] rounded-lg request"
                                key={e.email}>
                                <div className="flex flex-col items-center gap-3">
                                    <div>
                                        <img
