      ...
      <div className="p-10">
        <div className="w-[95%] bg-white shadow-xl rounded-lg text-gray-900 pb-5">
          ...
          <div className="text-center mt-2">
            <h2 className="font-semibold">{userData.firstName || 'First Name'}</h2>
          ...
          <ul className="flex justify-center pt-3 gap-7">
            <li className="flex flex-col items-center justify-around">
              ...
              <h6 className="text-base font-bold">{userData.post?.length || 0}</h6>
            </li>
            <li className="flex flex-col items-center justify-around">
              <h3 className="text-base font-bold">Followers</h3>
              <h6 className="text-base font-bold">{userData.followers.length}</h6>
            </li>
            <li className="flex flex-col items-center justify-around">
          ...
          <div className="w-[32%] h-[50vh] border shadow-lg rounded-xl mx-2 bg-white mt-3">
            <div className="p-4">
              ...
              <p className="font-medium text-gray-500 leading-6 text-xs mb-0">
                {userData.bio || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus."}
              </p>
            </div>
